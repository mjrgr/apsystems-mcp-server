...
- [APsystems MCP Server ☀️🛰️](#apsystems-mcp-server-️️)
  - [Table of Contents](#table-of-contents)
  - [Features](#features)
  - [Quick Start](#quick-start)
    - [🚀 Prerequisites](#-prerequisites)
    - [Install \& Run](#install--run)
    - [With SSE Transport](#with-sse-transport)
  ...
  - [MCP Tools Reference](#mcp-tools-reference)
    ...
    - [ECU Tools](#ecu-tools)
    - [Inverter Tools](#inverter-tools)
    - [Meter Tools](#meter-tools)
  ...
  - [Using with Claude CLI](#using-with-claude-cli)
    ...
    - [2. Configure Claude CLI](#2-configure-claude-cli)
