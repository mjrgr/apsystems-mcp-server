# Contributing to APsystems MCP Server
...
## Reporting Issues
- Use [GitHub Issues](https://github.com/mjrgr/apsystems-mcp-server/issues) for bugs and feature requests
- Provide as much detail as possible (logs, steps to reproduce, environment)
...
## Questions?
- Use [Discussions](https://github.com/mjrgr/apsystems-mcp-server/discussions) for Q&A and ideas
- For sensitive issues, email the maintainers
